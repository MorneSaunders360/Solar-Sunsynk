        ...
        try:
            ...
            for invertor in jsondata:
                ...
                try:
                    ...
                    inverterdata.update({"Instantaneous Grid I/O Total": _inverter_grid_data[0].get("limiterTotalPower", 0)})
                    ...
                    inverterdata.update({"Instantaneous Load": _inverter_load_data[0].get("totalPower", 0)})
